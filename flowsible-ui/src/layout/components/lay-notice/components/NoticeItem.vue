...
function hoverDescription(event, description) {
  // currentWidth For the width of the text on the page，Create a label，Add to page，GetcurrentWidth ,Finally remove
  ...
  // cellWidthFor the width of the container
  const cellWidth = event.target.offsetWidth;

  // When the text width is greater than twice the container width，Represents that the text displays more than two lines
