...
interface Props {
  /** Popup window display and hiding */
  value: boolean;
}
...
/** Flatten the menu tree structure into a one-dimensional array，For menu query */
...
/** Get the current option and path */
...
/** Update the path and scroll to the specified item */
...
/** Drag to change the order of collection */
...
<template>
  ...
  >
    <el-input
      ...
      size="large"
      clearable
      placeholder="Search menu（Support pinyin search）"
      @input="handleSearch"
    >
      <template #prefix>
        <IconifyIconOffline
    ...
    <div class="search-content">
      <el-scrollbar ref="scrollbarRef" max-height="calc(90vh - 140px)">
        <el-empty v-if="showEmpty" description="No search results" />
        <SearchHistory
