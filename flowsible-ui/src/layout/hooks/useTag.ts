...
export function useTags() {
  ...
  // Current right-click selected route information
  ...
  /** Whether to hide the tab，Default display */
  const showTags =
    ref(
      storageLocal().getItem<StorageConfigs>(
        `${responsiveStorageNameSpace()}configure`
  ...
  /** Move mouse in to add activation style */
  ...
  /** Move mouse out to restore default style */
