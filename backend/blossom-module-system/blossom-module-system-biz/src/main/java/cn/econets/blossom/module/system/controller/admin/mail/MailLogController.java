...
import cn.econets.blossom.module.system.controller.admin.mail.vo.log.MailLogRespVO;
import cn.econets.blossom.module.system.dal.dataobject.mail.MailLogDO;
import cn.econets.blossom.module.system.service.mail.MailLogService;
...
@Tag(name = "Management Backend - Mail log")
@RestController
...
public class MailLogController {
    ...
    @GetMapping("/page")
    @Operation(summary = "Get mailbox log paging")
    ...
    @GetMapping("/get")
    @Operation(summary = "Get mailbox log")
