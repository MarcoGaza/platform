package cn.econets.blossom.module.system.dal.mysql.notify;
...
public interface NotifyMessageMapper extends BaseMapperX<NotifyMessageDO> {
    ...
    default List<NotifyMessageDO> selectUnreadListByUserIdAndUserType(Long userId, Integer userType, Integer size) {
        return selectList(new QueryWrapperX<NotifyMessageDO>() // Because of the need to use limitN Statement，So you can only use QueryWrapperX
                .eq("user_id", userId)
