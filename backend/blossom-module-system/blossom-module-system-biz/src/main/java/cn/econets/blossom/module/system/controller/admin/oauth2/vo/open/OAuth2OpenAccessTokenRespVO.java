...
@Schema(description = "Management Backend - 【Open interface】Access Token Response VO")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class OAuth2OpenAccessTokenRespVO {
    ...
    @Schema(description = "Expiration time,Unit：seconds", requiredMode = Schema.RequiredMode.REQUIRED, example = "42430")
    @JsonProperty("expires_in")
    private Long expiresIn;

    @Schema(description = "Authorization scope,If multiple authorization scopes，Use spaces to separate", example = "user_info")
