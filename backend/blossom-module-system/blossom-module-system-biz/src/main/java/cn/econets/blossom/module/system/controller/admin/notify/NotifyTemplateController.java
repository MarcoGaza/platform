...
import cn.econets.blossom.module.system.controller.admin.notify.vo.template.*;
...
import cn.econets.blossom.module.system.service.notify.NotifyTemplateService;
...
@Tag(name = "Management Backend - Internal message template")
@RestController
...
public class NotifyTemplateController {
    ...
    @PostMapping("/create")
    @Operation(summary = "Create a template for internal messages")
    ...
    @PutMapping("/update")
    @Operation(summary = "Update the internal message template")
    ...
    @Operation(summary = "Delete the internal message template")
    ...
    @GetMapping("/get")
    @Operation(summary = "Get the internal message template")
    ...
    @GetMapping("/page")
    @Operation(summary = "Get the template paging for in-site messages")
    @PreAuthorize("@ss.hasPermission('system:notify-template:query')")
