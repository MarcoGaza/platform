...
/**
 * System Dictionary type enumeration class
 *
 */
public interface DictTypeConstants {
    ...
    String OPERATE_TYPE = "system_operate_type"; // Operation type

    String LOGIN_TYPE = "system_login_type"; // Login log type
    String LOGIN_RESULT = "system_login_result"; // Login result

    String ERROR_CODE_TYPE = "system_error_code_type"; // Error code type enumeration
