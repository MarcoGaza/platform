package cn.econets.blossom.module.crm.controller.admin.followup;
...
import cn.econets.blossom.module.crm.controller.admin.followup.vo.CrmFollowUpRecordRespVO;
...
@Tag(name = "Management Backend - Follow-up records")
@RestController
...
public class CrmFollowUpRecordController {
    ...
    @PostMapping("/create")
    @Operation(summary = "Create a follow-up record")
    ...
    @Operation(summary = "Delete follow-up records")
    ...
    @GetMapping("/get")
    @Operation(summary = "Get follow-up records")
    ...
    @GetMapping("/page")
    @Operation(summary = "Get follow-up record paging")
    @PreAuthorize("@ss.hasPermission('crm:follow-up-record:query')")
