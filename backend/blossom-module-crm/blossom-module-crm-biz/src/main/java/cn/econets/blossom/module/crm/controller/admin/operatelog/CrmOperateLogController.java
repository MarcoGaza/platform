...
@Tag(name = "Management Backend - CRM Operation log")
@RestController
...
public class CrmOperateLogController {
    ...
    /**
     * {@link CrmBizTypeEnum} with {@link LogRecordConstants} Mapping relationship
     */
    ...
    @GetMapping("/page")
    @Operation(summary = "Get operation log")
    ...
    public CommonResult<PageResult<CrmOperateLogV2RespVO>> getCustomerOperateLog(@Valid CrmOperateLogPageReqVO pageReqVO) {
        ...
        reqDTO.setPageSize(PAGE_SIZE_NONE); // No paging by default，Pagination and comments are required
