...
@Schema(description = "Management Backend - Business Opportunity Transfer Request VO")
@Data
public class CrmBusinessTransferReqVO {

    @Schema(description = "Opportunity Number", requiredMode = Schema.RequiredMode.REQUIRED, example = "10430")
