package cn.econets.blossom.module.bpm.convert.task;
...
public interface BpmTaskConvert {
    ...
    //Not used here mapstruct Mapping，Because TaskEntityImpl There are many other properties，Here we only set what we need
    //Use mapstruct All nested attribute values ​​will be set，Unexpected problems may occur
    ...
    default List<BpmTaskSubSignRespVO> convertList(List<BpmTaskExtDO> bpmTaskExtDOList,
        ...
        return CollectionUtils.convertList(bpmTaskExtDOList, task -> {
            ...
            // The post-signature task will not be set directly assignee ,So it does not exist assignee Situation，Go get it owner
    ...
    /**
     * Convert tasks to parent-child level
     *
     * @param sourceList Original data
     * @return The converted parent-child array
     */
