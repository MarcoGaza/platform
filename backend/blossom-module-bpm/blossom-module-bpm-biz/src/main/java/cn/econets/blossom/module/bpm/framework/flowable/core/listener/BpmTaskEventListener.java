...
/**
 * Monitor {@link Task} The beginning and end of，Create and update corresponding {@link BpmTaskExtDO} Record
 *
 */
@Component
@Slf4j
public class BpmTaskEventListener extends AbstractFlowableEngineEventListener {
    ...
    protected void activityCancelled(FlowableActivityCancelledEvent event) {
        ...
        if (CollUtil.isEmpty(activityList)) {
            log.error("[activityCancelled][Use executionId({}) Cannot find the corresponding activity instance]", event.getExecutionId());
            return;
        }
