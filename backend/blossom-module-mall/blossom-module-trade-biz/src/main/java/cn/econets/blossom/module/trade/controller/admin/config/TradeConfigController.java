package cn.econets.blossom.module.trade.controller.admin.config;
...
@Tag(name = "Management Backend - Trading Center Configuration")
@RestController
...
public class TradeConfigController {
    ...
    @PutMapping("/save")
    @Operation(summary = "Update trading center configuration")
    ...
    @GetMapping("/get")
    @Operation(summary = "Get trading center configuration")
