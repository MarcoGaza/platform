package cn.econets.blossom.module.trade.controller.app.base.property;
...
public class AppProductPropertyValueDetailRespVO {
    ...
    @Schema(description = "The number of the attribute value", requiredMode = Schema.RequiredMode.REQUIRED, example = "1024")
