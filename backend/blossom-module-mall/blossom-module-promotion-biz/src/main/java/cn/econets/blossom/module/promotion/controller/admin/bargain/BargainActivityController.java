...
import cn.econets.blossom.module.promotion.controller.admin.bargain.vo.activity.*;
...
@Tag(name = "Management Backend - Bargaining activity")
@RestController
...
public class BargainActivityController {
    ...
    @PostMapping("/create")
    @Operation(summary = "Create a bargaining activity")
    ...
    @PutMapping("/update")
    @Operation(summary = "Update bargaining activity")
    ...
    @PutMapping("/close")
    @Operation(summary = "Close the bargaining activity")
    ...
    @Operation(summary = "Delete bargaining activity")
    @Parameter(name = "id", description = "Number", required = true)
    ...
    @GetMapping("/get")
    @Operation(summary = "Get bargaining activity")
