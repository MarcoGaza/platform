package cn.econets.blossom.module.mp.controller.admin.statistics;

import cn.econets.blossom.framework.common.pojo.CommonResult;
import cn.econets.blossom.module.mp.controller.admin.statistics.vo.*;
import cn.econets.blossom.module.mp.convert.statistics.MpStatisticsConvert;
import cn.econets.blossom.module.mp.service.statistics.MpStatisticsService;
...
@Tag(name = "Management Backend - Public Account Statistics")
@RestController
...
public class MpStatisticsController {
    ...
    @Operation(summary = "Get the data of the increase and decrease of fans")
    ...
    @Operation(summary = "Get the cumulative data of fans")
    @PreAuthorize("@ss.hasPermission('mp:statistics:query')")
    ...
    @Operation(summary = "Get message sending profile data")
    @PreAuthorize("@ss.hasPermission('mp:statistics:query')")
