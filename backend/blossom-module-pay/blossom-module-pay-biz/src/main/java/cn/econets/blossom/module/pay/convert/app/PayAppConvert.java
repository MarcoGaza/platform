package cn.econets.blossom.module.pay.convert.app;

import cn.econets.blossom.framework.common.pojo.PageResult;
import cn.econets.blossom.framework.common.util.collection.CollectionUtils;
import cn.econets.blossom.module.pay.controller.admin.app.vo.PayAppCreateReqVO;
import cn.econets.blossom.module.pay.controller.admin.app.vo.PayAppPageItemRespVO;
import cn.econets.blossom.module.pay.controller.admin.app.vo.PayAppRespVO;
...
/**
 * Payment application information Convert
 *
 *
 */
@Mapper
public interface PayAppConvert {
    ...
    default PageResult<PayAppPageItemRespVO> convertPage(PageResult<PayAppDO> pageResult, List<PayChannelDO> channels) {
        ...
        // Processing channel Relationship
