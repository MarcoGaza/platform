package cn.econets.blossom.module.pay.controller.admin.order;
...
public class PayOrderController {
    ...
    @Operation(summary = "Get payment order details")
    @Parameter(name = "id", description = "Number", required = true, example = "1024")
    @PreAuthorize("@ss.hasPermission('pay:order:query')")
    ...
    @GetMapping("/page")
    @Operation(summary = "Get payment order paging")
    @PreAuthorize("@ss.hasPermission('pay:order:query')")
    ...
    @Operation(summary = "Export payment orders Excel")
    ...
    public void exportOrderExcel(@Valid PayOrderExportReqVO exportReqVO,
        ...
        if (CollectionUtil.isEmpty(list)) {
            ExcelUtils.write(response, "Payment order.xls", "Data",
        ...
        // Export Excel
        ExcelUtils.write(response, "Payment order.xls", "Data", PayOrderExcelVO.class, excelList);
    }
